...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactHelmet = __webpack_require__(290);
	...
	var serialize = __webpack_require__(316); /* eslint-disable no-console, no-use-before-define */
	...
	var reactAppServer = function reactAppServer(req, res) {
	  ...
	  (0, _reactRouter.match)({ routes: _router2.default, location: req.url }, function (error, redirectLocation, renderProps) {
	    ...
	    var template = _fs2.default.readFileSync(_path2.default.output.index, 'utf8');
	    ...
	    var updateData = Comp && Comp.updateData || function () {
	      return _promise2.default.resolve();
	    };
	    /////////////////////////
	    ...
	    if (params && params.id && req.url.indexOf('courses') > -1) {
	      updateData({ store: store, params: params }).catch(function (err) {
	    ...
	    fetchData({ store: store, location: location, params: params, history: history }).then(function () {
	      ...
	      if (false) {
	        ...
	        var scripts = '<script type="text/javascript" src="/main.js"></script>';
	      ...
	      var appStartIndex = template.indexOf('<main id=app></main>');
	      ...
	      res.write('<script>\n            window.__PRELOADED_STATE__ = ' + (0, _stringify2.default)(finalState).replace(/</g, '\\x3c') + '\n          </script>');
	...
	function renderFullPage(html, head, initialState) {
	  var scripts = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : '';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AboutPage = __webpack_require__(291);

	var _AboutPage2 = _interopRequireDefault(_AboutPage);

	var _CoursesPage = __webpack_require__(292);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoadingDots = __webpack_require__(267);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _courseActions = __webpack_require__(293);

	var courseActions = _interopRequireWildcard(_courseActions);

	var _CourseList = __webpack_require__(297);
	...
	CoursesPage.fetchData = function (obj) {
	  return obj.store.dispatch(courseActions.loadCourses());
	};

	CoursesPage.updateData = function (obj) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mockCourseApi = __webpack_require__(294);

	var _mockCourseApi2 = _interopRequireDefault(_mockCourseApi);

	var _ajaxStatusActions = __webpack_require__(296);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _delay = __webpack_require__(295);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CourseListRow = __webpack_require__(298);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _authorActions = __webpack_require__(302);

	var authorActions = _interopRequireWildcard(_authorActions);

	var _CourseForm = __webpack_require__(304);

	var _CourseForm2 = _interopRequireDefault(_CourseForm);

	var _selectors = __webpack_require__(307);
	...
	var ManageCoursePage = exports.ManageCoursePage = function (_Component) {
	  ...
	  (0, _createClass3.default)(ManageCoursePage, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      alertify = __webpack_require__(311);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mockAuthorApi = __webpack_require__(303);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TextInput = __webpack_require__(305);

	var _TextInput2 = _interopRequireDefault(_TextInput);

	var _SelectInput = __webpack_require__(306);
	...
	var CourseForm = function CourseForm(_ref) {
	  ...
	  return (0, _jsx3.default)('form', {
	    action: '/courses/',
	    method: 'get'
	  }, void 0, _ref2, _ref3, (0, _jsx3.default)(_TextInput2.default, {
	    hidden: true,
	    onChange: onChange,
	    name: 'id',
	    label: 'id',
