...
/***/ function(module, exports, __webpack_require__) {
	...
	var _qs = __webpack_require__(87);
	...
	var _fsExtra = __webpack_require__(89);
	...
	var _meta = __webpack_require__(307);

	var _meta2 = _interopRequireDefault(_meta);

	var _reactHelmet = __webpack_require__(289);
	...
	var reactAppServer = function reactAppServer(req, res) {
	  // Query our mock API asynchronously
	  (0, _reactRouter.match)({ routes: _router2.default, location: req.url }, function (error, redirectLocation, renderProps) {
	    ...
	    var styles = void 0;
	    if (true) {
	      var clientInfo = _fsExtra2.default.readJSONSync(_path2.default.asset.client_info);
	      var main = clientInfo.assetsByChunkName.main;


	      scripts = [].concat(Array.isArray(main) ? main : [main]).filter(function (asset) {
	        return (/\.(js)$/i.test(asset)
	        );
	      }).map(function (asset, i) {
	        return '<script key=' + i + ' type="text/javascript" src=/' + asset + '></script>';
	      });

	      styles = [].concat(Array.isArray(main) ? main : [main]).filter(function (asset) {
	        return (/\.(css)$/i.test(asset)
	        );
	      }).map(function (asset, i) {
	        return '<link key=' + i + ' rel="stylesheet" href="/' + asset + '" />';
	      });
	    } else {
	    ...
	    var params2 = renderProps.params;
	    ...
	    var memoryHistory = (0, _createMemoryHistory2.default)(req.url);

	    // Create a new Redux store instance
	    var store = (0, _configureStore2.default)(_initialState2.default, memoryHistory);
	    ...
	    fetchData({ store: store, location: location, params: params, history: history }).then(function () {
	      ...
	      head.title = _meta2.default.title.get(location.pathname) || '';
	      // Render the component to a string
	      var html = (0, _server.renderToString)(_ref);
	...
	function renderFullPage(html, head, initialState, scripts, styles) {
	  return '\n    <!doctype html>\n    <html>\n      <head>\n        <title>' + head.title.toString() + '</title>\n      </head>\n      <body>\n        <div id="app">' + html + '</div>\n        <script>\n          window.__PRELOADED_STATE__ = ' + (0, _stringify2.default)(initialState).replace(/</g, '\\x3c') + '\n        </script>\n        ' + scripts + '\n      </body>\n    </html>\n  ';
	}

	exports.default = reactAppServer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(15)(IteratorPrototype, __webpack_require__(28)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactServerRendering = __webpack_require__(229);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PooledClass = __webpack_require__(108);
	var ReactPerf = __webpack_require__(118);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DOMProperty = __webpack_require__(134);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _runTransitionHook = __webpack_require__(244);
	...
	var configureStore = function configureStore(preloadedState) {
	  ...
	  if (false) {
	    ...
	    module.hot.accept('../reducer', function () {
	      var nextRootReducer = require('../reducer').default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _courseReducer = __webpack_require__(250);

	var _courseReducer2 = _interopRequireDefault(_courseReducer);

	var _authorReducer = __webpack_require__(261);

	var _authorReducer2 = _interopRequireDefault(_authorReducer);

	var _ajaxStatusReducer = __webpack_require__(262);
	...
	var rootReducer = (0, _redux.combineReducers)({
	  ...
	  courses: _courseReducer2.default, // : courses (we don't add it because it's ES6)
	...
	function courseReducer() {
	  ...
	  switch (action.type) {
	    ...
	    case types.CREATE_COURSE_SUCCESS:
	      return [].concat((0, _toConsumableArray3.default)(state), [(0, _assign2.default)({}, action.course)]);

	    case types.UPDATE_COURSE_SUCCESS:
	      return [].concat((0, _toConsumableArray3.default)(state.filter(function (course) {
	        return course.id !== action.course.id;
	      })), [(0, _assign2.default)({}, action.course)]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AboutPage = __webpack_require__(290);

	var _AboutPage2 = _interopRequireDefault(_AboutPage);

	var _CoursesPage = __webpack_require__(291);

	var _CoursesPage2 = _interopRequireDefault(_CoursesPage);

	var _CourseForm = __webpack_require__(298);
	...
	exports.default = (0, _jsx3.default)(_reactRouter.Route, {
	  ...
	  path: 'courses',
	  component: _CoursesPage2.default
	}), (0, _jsx3.default)(_reactRouter.Route, {
	  path: 'course',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LoadingDots = __webpack_require__(266);
	...
	var _ref2 = (0, _jsx3.default)(_reactRouter.IndexLink, {
	  to: '/',
	  activeClassName: 'active'
	}, void 0, 'Home');

	var _ref3 = (0, _jsx3.default)(_reactRouter.Link, {
	  to: '/courses',
	  activeClassName: 'active'
	}, void 0, 'Courses');

	var _ref4 = (0, _jsx3.default)(_reactRouter.Link, {
	  to: '/about',
	  activeClassName: 'active'
	}, void 0, 'About');

	var _ref5 = (0, _jsx3.default)(_LoadingDots2.default, {
	  interval: 100,
	  dots: 20
	});
	...
	var Header = function Header(_ref) {
	  ...
	  return (0, _jsx3.default)('nav', {
	    className: 'nav'
	  }, void 0, _ref2, " | ", _ref3, " | ", _ref4, loading && _ref5);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inherits2 = __webpack_require__(280);
	...
	var LoadingDots = function (_Component) {
	  (0, _inherits3.default)(LoadingDots, _Component);

	  function LoadingDots(props, context) {
	    (0, _classCallCheck3.default)(this, LoadingDots);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (LoadingDots.__proto__ || (0, _getPrototypeOf2.default)(LoadingDots)).call(this, props, context));

	    _this.state = { frame: 1 };
	    return _this;
	  }

	  (0, _createClass3.default)(LoadingDots, [{
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(10), 'Object', {defineProperty: __webpack_require__(16).f});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _setPrototypeOf = __webpack_require__(281);
...
/***/ function(module, exports, __webpack_require__) {
	...
	}), (0, _jsx3.default)('h1', {}, void 0, 'Courses Administration'), (0, _jsx3.default)('p', {}, void 0, 'React, Redux, and React Router'), (0, _jsx3.default)(_reactRouter.Link, {
	  to: 'about',
...
/***/ function(module, exports, __webpack_require__) {
	...
	}), (0, _jsx3.default)("h1", {}, void 0, "About"), (0, _jsx3.default)("p", {}, void 0, "This is app uses React, Redux, and React Redux."));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _courseActions = __webpack_require__(292);

	var courseActions = _interopRequireWildcard(_courseActions);

	var _CourseList = __webpack_require__(296);
	...
	var _ref2 = (0, _jsx3.default)('h1', {}, void 0, 'Courses');
	...
	var CoursesPage = function (_React$Component) {
	  (0, _inherits3.default)(CoursesPage, _React$Component);

	  function CoursesPage(props, context) {
	    (0, _classCallCheck3.default)(this, CoursesPage);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (CoursesPage.__proto__ || (0, _getPrototypeOf2.default)(CoursesPage)).call(this, props, context));

	    _this.redirectToAddCoursePage = _this.redirectToAddCoursePage.bind(_this);
	    return _this;
	  }

	  (0, _createClass3.default)(CoursesPage, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	    ...
	    value: function courseRow(course, index) {
	      return (0, _jsx3.default)('div', {}, index, course.title);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return (0, _jsx3.default)('div', {}, void 0, _ref, _ref2, _ref3, (0, _jsx3.default)(_CourseList2.default, {
	        courses: courses
	      }));
	    }
	  }]);
	...
	CoursesPage.fetchData = function (_ref4) {
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProp)(CoursesPage);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.loadCoursesSucess = loadCoursesSucess;
	...
	var _mockCourseApi = __webpack_require__(293);

	var _mockCourseApi2 = _interopRequireDefault(_mockCourseApi);

	var _ajaxStatusActions = __webpack_require__(295);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _delay = __webpack_require__(294);
	...
	var CourseApi = function () {
	  function CourseApi() {
	    (0, _classCallCheck3.default)(this, CourseApi);
	  }

	  (0, _createClass3.default)(CourseApi, null, [{
	    key: "getAllCourses",
	    value: function getAllCourses() {
	      return new _promise2.default(function (resolve, reject) {
	        setTimeout(function () {
	          resolve((0, _assign2.default)([], courses));
	        }, _delay2.default);
	      });
	    }
	  }, {
	    ...
	    value: function saveCourse(course) {
	      course = (0, _assign2.default)({}, course); //  to avoid manipulating object passed in.
	      return new _promise2.default(function (resolve, reject) {
	        setTimeout(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CourseListRow = __webpack_require__(297);

	var _CourseListRow2 = _interopRequireDefault(_CourseListRow);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var _ref2 = (0, _jsx3.default)('thead', {}, void 0, (0, _jsx3.default)('tr', {}, void 0, (0, _jsx3.default)('th', {}, void 0, '\xA0'), (0, _jsx3.default)('th', {}, void 0, 'Title'), (0, _jsx3.default)('th', {}, void 0, 'Author'), (0, _jsx3.default)('th', {}, void 0, 'Category'), (0, _jsx3.default)('th', {}, void 0, 'Length')));
	...
	var CourseList = function CourseList(_ref) {
	  ...
	  return (0, _jsx3.default)('table', {
	    className: 'table'
	  }, void 0, _ref2, (0, _jsx3.default)('tbody', {}, void 0, courses.map(function (course) {
	    return (0, _jsx3.default)(_CourseListRow2.default, {
	      course: course
	    }, course.id);
	  })));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CourseListRow = function CourseListRow(props) {
	  return (0, _jsx3.default)('tr', {
	    className: 'row'
	  }, void 0, (0, _jsx3.default)('td', {}, void 0, (0, _jsx3.default)('a', {
	    className: 'row__link',
	    href: props.course.watchHref,
	    target: '_blank'
	  }, void 0, 'Watch')), (0, _jsx3.default)('td', {}, void 0, (0, _jsx3.default)(_reactRouter.Link, {
	    className: 'row__link row__link--secondary',
	    to: '/course/' + props.course.id
	  }, void 0, props.course.title)), (0, _jsx3.default)('td', {}, void 0, props.course.authorId), (0, _jsx3.default)('td', {}, void 0, props.course.category), (0, _jsx3.default)('td', {}, void 0, props.course.length));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ManageCoursePage = undefined;
	...
	var _authorActions = __webpack_require__(299);

	var authorActions = _interopRequireWildcard(_authorActions);

	var _CourseForm = __webpack_require__(301);

	var _CourseForm2 = _interopRequireDefault(_CourseForm);

	var _selectors = __webpack_require__(304);
	...
	var ManageCoursePage = exports.ManageCoursePage = function (_Component) {
	  (0, _inherits3.default)(ManageCoursePage, _Component);

	  function ManageCoursePage(props, context) {
	    (0, _classCallCheck3.default)(this, ManageCoursePage);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (ManageCoursePage.__proto__ || (0, _getPrototypeOf2.default)(ManageCoursePage)).call(this, props, context));

	    _this.state = {
	      course: (0, _assign2.default)({}, props.course),
	      errors: {},
	      saving: false
	    };
	  ...
	  (0, _createClass3.default)(ManageCoursePage, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (this.props.course.id !== nextProps.course.id) {
	        ...
	        this.setState({ course: (0, _assign2.default)({}, nextProps.course) });
	      }
	    }
	  }, {
	    ...
	    key: 'courseFormIsValid',
	    value: function courseFormIsValid() {
	    ...
	    value: function saveCourse(event) {
	      ...
	      this.props.actions.saveCourse(this.state.course).then(function () {
	        return _this2.redirect('/courses');
	      }).catch(function (error) {
	    ...
	    key: 'redirect',
	    value: function redirect(newPage) {
	    ...
	    key: 'render',
	    value: function render() {
	      return (0, _jsx3.default)(_CourseForm2.default, {
	...
	ManageCoursePage.fetchData = function (_ref) {
	...
	function mapStateToProps(state, ownProps) {
	  ...
	  return {
	    course: course,
	    authors: (0, _selectors.authorsFormattedForDropdown)(state)
	  };
	}

	function mapDispatchToProps(dispatch) {
	  var actions = (0, _assign2.default)({}, authorActions, courseActions);
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.loadAuthorsSucess = loadAuthorsSucess;
	...
	var _mockAuthorApi = __webpack_require__(300);
...
/***/ function(module, exports, __webpack_require__) {
	...
	//  This would be performed on the server in a real app. Just stubbing in.
	var generateId = function generateId(author) {
	  return author.firstName.toLowerCase() + '-' + author.lastName.toLowerCase();
	};

	var AuthorApi = function () {
	  function AuthorApi() {
	    (0, _classCallCheck3.default)(this, AuthorApi);
	  }

	  (0, _createClass3.default)(AuthorApi, null, [{
	    key: 'getAllAuthors',
	    value: function getAllAuthors() {
	      return new _promise2.default(function (resolve, reject) {
	        setTimeout(function () {
	          resolve((0, _assign2.default)([], authors));
	        }, _delay2.default);
	      });
	    }
	  }, {
	    key: 'saveAuthor',
	    value: function saveAuthor(author) {
	      return new _promise2.default(function (resolve, reject) {
	        setTimeout(function () {
	          // Simulate server-side validation
	          var minAuthorNameLength = 3;
	          ...
	          if (author.id) {
	            var existingAuthorIndex = authors.findIndex(function (a) {
	          ...
	          resolve((0, _assign2.default)({}, author));
	        }, _delay2.default);
	      });
	    }
	  }, {
	    ...
	    value: function deleteAuthor(authorId) {
	      return new _promise2.default(function (resolve, reject) {
	        setTimeout(function () {
	          var indexOfAuthorToDelete = authors.findIndex(function (author) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TextInput = __webpack_require__(302);

	var _TextInput2 = _interopRequireDefault(_TextInput);

	var _SelectInput = __webpack_require__(303);
	...
	var _ref3 = (0, _jsx3.default)('h1', {}, void 0, 'Manage Course');
	...
	var CourseForm = function CourseForm(_ref) {
	  ...
	  return (0, _jsx3.default)('form', {}, void 0, _ref2, _ref3, (0, _jsx3.default)(_TextInput2.default, {
	    name: 'title',
	    label: 'Title',
	    value: course.title,
	    onChange: onChange,
	    error: errors.title
	  }), (0, _jsx3.default)(_SelectInput2.default, {
	    name: 'authorId',
	    label: 'Author',
	  ...
	  }), (0, _jsx3.default)(_TextInput2.default, {
	    name: 'category',
	    label: 'Category',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TextInput = function TextInput(_ref) {
	  ...
	  return (0, _jsx3.default)('div', {
	    ...
	    htmlFor: name
	  }, void 0, label), (0, _jsx3.default)('div', {
	    className: 'field'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SelectInput = function SelectInput(_ref) {
	  ...
	  return (0, _jsx3.default)("div", {
	    ...
	    value: ""
	  }, void 0, defaultOption), options.map(function (option) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.authorsFormattedForDropdown = undefined;

	var _reselect = __webpack_require__(305);

	var getAuthors = function getAuthors(state) {
	...
	var authorsFormattedForDropdown = exports.authorsFormattedForDropdown = (0, _reselect.createSelector)([getAuthors], function (authors) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _require = __webpack_require__(309),
	    join = _require.join,
	    posix = _require.posix;

	var root = join(__dirname, '../');
	var common = join(__dirname, '../common');
	...
	module.exports = {
	  ...
	  output: {
	    ...
	    index: join(root, 'dist/' + ( true ? '' : '_') + 'index.html'),
	    path: join(root, 'dist'),
	    server: join(root, 'dist/server.js'),
	    public: '/',
	    getAssetPosixPath: function getAssetPosixPath(subpath) {
